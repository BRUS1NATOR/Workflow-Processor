...
namespace WorkflowProcessor.Migrations
{
    ...
    [Migration("20250417070348_ParallelExecutionInfo")]
    partial class ParallelExecutionInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowProcessor.Core.ParallelExecutionInfo", b =>
                {
                    ...
                    b.Property<int>("ActivatedConnectionsCount")
                        .HasColumnType("integer")
                        .HasColumnName("activated_connections_count")
                        .HasAnnotation("Relational:JsonPropertyName", "activatedConnectionsCount");
                    ...
                    b.Property<int>("FinishedConnectionsCount")
                        .HasColumnType("integer")
                        .HasColumnName("finished_connections_count")
                        .HasAnnotation("Relational:JsonPropertyName", "finishedConnectionsCount");
                    ...
                    b.ToTable("ParallelExecutionInfo");

                    b.HasAnnotation("Relational:JsonPropertyName", "parallelExecutionInfo");
                });
            ...
            modelBuilder.Entity("WorkflowProcessor.Core.ParallelExecutionInfo", b =>
                {
                    b.HasOne("WorkflowProcessor.Core.WorkflowInstance", "WorkflowInstance")
                        .WithMany("ParallelExecutionInfo")
                        .HasForeignKey("WorkflowInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("WorkflowProcessor.Core.WorkflowInstance", b =>
                {
                    ...
                    b.Navigation("ParallelExecutionInfo");
